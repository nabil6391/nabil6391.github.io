...
const SocialIcons = (props, context) => {
    ...
    return (
        <div className="social-icons animate-icons">
            <a target="_blank" rel="noopener noreferrer" href="https://github.com/nabil6391"
               style={{color: colorPrimary}}><i className="fab fa fa-github"></i></a>
            ...
            <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/nabil-mosharraf-96560333"
               style={{color: colorPrimary}}><i className="fab fa fa-linkedin"></i></a>
            <a target="_blank" rel="noopener noreferrer" href="https://medium.com/@nabil6391"
               style={{color: colorPrimary}}><i className="fab fa fa-medium"></i></a>
